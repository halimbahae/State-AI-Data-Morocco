...
const Card = ({ title, icon, children }: CardProps) => (
    <li className="bg-gradient-to-t stack-cards__item sg0-bg-light sg0-radius-lg sg0-inner-glow sg0-shadow-md js-stack-cards__item">
        <div className="sg0-flex sg0-flex-center flex flex-col items-center justify-center p-20 gap-20">

            <div className="text-secondary mr-4 text-4xl">{icon}</div>

            <p className="text-black text-3xl"  >{children}</p>
        </div>
  </li>
);
